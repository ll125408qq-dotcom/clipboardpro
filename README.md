...
前往 [Releases](https://github.com/ll125408qq-dotcom/win-clipboard/releases) 页面，下载最新的 `win新剪贴板 Setup x.x.x.exe`：
...
```bash
# 克隆仓库
git clone https://github.com/ll125408qq-dotcom/win-clipboard.git
cd win-clipboard
